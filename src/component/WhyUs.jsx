    ...
    <section id="whyUs">
        ...
        <!-- col-lg-3 (dibagi menjadi 4 kolom (12/4)) akan di terapkan di ukuran layar mulai 992px keatas --> */}
            <div className="col-12 col-md-6 col-lg-3 my-2">
              <div className="card">
                <div className="card-body">
                  <img src={assets.lengkap} className="mb-4" alt="TMMIN Car Rental - Mobil Lengkap" />
            ...
            <div className="col-12 col-md-6 col-lg-3 my-2">
              <div className="card">
                <div className="card-body">
                  <img src={assets.harga} className="mb-4" alt="TMMIN Car Rental - Harga Murah" />
            ...
            <div className="col-12 col-md-6 col-lg-3 my-2">
              <div className="card">
                <div className="card-body">
                  <img src={assets.jam} className="mb-4" alt="TMMIN Car Rental - Layanan 24 Jam" />
            ...
            <div className="col-12 col-md-6 col-lg-3 my-2">
              <div className="card">
                <div className="card-body">
                  <img src={assets.profesional} className="mb-4" alt="TMMIN Car Rental - Sopir Profesional" />
